            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Teacher's Payment - Paid</h1>
                    </div>
                                ...
                                <tbody>
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                if ($selectRow = mysqli_fetch_array($selectResult)) {
                                                    ...
                                                    if ($inststatus == 'paid') {
                                                        ...
                                                        // $imagePath = isset($row['profile_image']) ? $row['profile_image'] : "";
                                                        ...
                                                        <tr data-id="<?php echo $row['id']; ?>" data-courses='<?php echo htmlspecialchars($coursesJson); ?>'>
                                                            ...
                                                            <td style="text-align: center;">
                                                                <button type="button" class="btn btn-success" onclick="viewInstructor('<?php echo $row['id'] ?>','<?php echo $row['FirstName'] ?>','<?php echo $row['LastName'] ?>', '<?php echo $row['Phone'] ?>', '<?php echo $row['Email'] ?>','<?php echo $row['DegreeP'] ?>','<?php echo htmlspecialchars($imageSrc); ?>', <?php echo htmlspecialchars($coursesJson); ?>)">
                                                                    View
                                                                </button>
                                                            </td>
                                                            <td style="text-align: center;">
