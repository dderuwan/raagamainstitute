...
<body id="page-top">
                    ...
                    <div class="col-12 ">
                        <div class="card shadow mb-4">
                            <table class="table" style="align-items: center;">
                                ...
                                <?php
                                $sql = "SELECT * FROM student WHERE status = 'Active' ORDER BY `id` ASC";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        $coursesSql = "
                                            ...
                                            WHERE 
                                                payedstudent.studentID = $studentID 
                                            GROUP BY 
                                        courses.id;";
                                            ...
                                            <tr>
                                                <th>
                                                    ...
                                                    if (empty($row['profile_image'])) {
                                                        echo '<img style="width:50px; height:50px; object-fit: cover;" class="img-fluid rounded-circle profile_image" src="../images/man3.png" alt="default image" />';
                                                    } else {
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-success" onclick="studentDetails(<?php echo $row['id'] ?>)">View</button>
                                                </td>
                                                </td>
    ...
    <script>
        function viewInstructor(id, firstname, lastname, phone, email, coursesData) {
            let coursesHtml = '';
            ...
            if (coursesData.length === 0) {
                ...
                coursesData.forEach(course => {
                    coursesHtml += `<tr style = "border-bottom: 1px solid #ddd;"><td style = "text-align: left;padding: 5px 0px;">${course.course_title}</td><td>${course.price}</td></tr>`;
                });
                coursesHtml += '</table>';
            }
