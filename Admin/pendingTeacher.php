...
<head>
    ...
    <script>
        function approveInstructor(id) {
            window.location.href = '../handlers/approveInstructor.php?id=' + id;
        }

        function blockInstructor(id) {
            window.location.href = '../handlers/blockInstructor.php?id=' + id;
        }
    </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pending Teacher</h1>
                    </div>
                    ...
                    <div class="col-12 ">
                        <div class="card shadow mb-4">
                            <table class="table" style="align-items: center;">
                                ...
                                <?php
                                $sql = "SELECT * FROM Instructors WHERE Status = 'Pending' ORDER BY `id` ASC";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tbody>
                                            <tr>
                                                <th><img src="<?php echo $row["imagePath"] ?>"
                                                ...
                                                <td><a href="<?php echo $row["pdfPath"] ?>"><button type="button"
                                                            class="btn btn-primary">View CV</button></a></td>
                                                ...
                                                <select name="status" id="status" onChange="updateStatus(this, '')">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button" class="btn btn-success"
                                                            onclick="approveInstructor(<?php echo $row['id'] ?>)">Approve</button>
