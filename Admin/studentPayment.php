                                ...
                                <tbody>
                                    ...
                                    $sql = "
                                        SELECT 
                                            student.*, 
                                            payedstudent.*, 
                                            package_type.name AS package_name,
                                            payedstudent.price AS package_price,
                                            courses.course_title
                                        FROM 
                                            student
                                        JOIN 
                                            payedstudent ON student.id = payedstudent.studentID
                                        JOIN 
                                            package_type ON payedstudent.packageType = package_type.id
                                        JOIN 
                                            courses ON payedstudent.course_id = courses.id
                                        WHERE 
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            if (!isset($studentsData[$studentID])) {
                                                $studentsData[$studentID] = $row;
                                                $studentsData[$studentID]['total_payment'] = 0;
                                            }

                                            $studentsData[$studentID]['total_payment'] += $row['package_price'];
                                            $studentsData[$studentID]['courses'][] = [
                                                'course_title' => $row['course_title'],
                                            ];
                                        }

                                        foreach ($studentsData as $studentID => $studentData) {
                                            $totalPaymentValue = number_format($studentData['total_payment'], 2);
                                    ?>
                                            ...
                                            <tr data-id="<?php echo $studentData['id']; ?>">
                                                <th>
                                                    ...
                                                    if (empty($studentData['profile_image'])) {
                                                        ...
                                                        $decoded_image = base64_decode($studentData['profile_image']);
                                                ...
                                                <td><?php echo htmlspecialchars($studentData["firstName"]); ?></td>
                                                ...
                                                <td><?php echo htmlspecialchars($studentData["Date"]); ?></td>
                                                <td><?php echo htmlspecialchars($studentData['package_name']); ?></td>
                                                <td><?php echo $totalPaymentValue; ?></td>
                                                <td style="text-align: center;">
                                    ...
                                    <?php
                                        ...
                                        echo "<tr><td colspan='7'>No paid students found.</td></tr>";
                                    }
                                    ?>
                                </tbody>
                                </tbody>
