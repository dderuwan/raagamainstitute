                    ...
                    <div class="col-12 ">
                        <div class="card shadow mb-4">
                            <table class="table" style="align-items: center;">
                              ...
                              <td><span class="text-dark bg-success p-2 rounded"><?php echo $row['status'] ?></span></td>
                                  ...
                                  -->
                                    ...
                                    <div class="row">
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    if ($row['status'] == 'Pending') {
                                                       ?>
                                                       <span class="btn btn-danger" style = "width: 102px;"><?php echo $row['status'] ?></span>
                                                       <?php
                                                    } else {
                                                        ?>
                                                        <span class="btn btn-success" style = "width: 102px;"><?php echo $row['status'] ?></span>
                                                        <?php
                                                    }
                                                    ?>
                                                    </td>
                                            ...
                                            echo "<tr><td colspan='8'><b>No courses found.</b></td></tr>";
                                        }
                                        ?>
                                        <hr>
                                    </div>
            ...
            if (selectedOption === 'yes') {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            title: "The status has been changed to changed!",
                            icon: "success"
                        });
                    }
                });
