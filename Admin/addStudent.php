                    ...
                    <form action="../handlers/studentregisterHandler.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="contact" id="phoneNumber"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputPassword4">Parent Contact No</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputPassword4">Grade or university</label>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="gridCheck">
                                    Confirm Add the student
                                </label>
                            </div>
                        </div>
                        <button type="submit" name="regNext" class="btn btn-primary" onclick="checkPassword()">Add
                            Student</button>
                    </form>
