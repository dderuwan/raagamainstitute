...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="allTeacher.php">All Teacher</a>
                <a class="collapse-item" href="pendingTeacher.php">Pending Teacher</a>
                <a class="collapse-item" href="blockedTeacher.php">Blocked Teacher</a>
    ...
    <li class="nav-item active">
        ...
        <div id="collapseStudent" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="allStudent.php">All Student</a>
                <a class="collapse-item" href="blockedStudent.php">Blocked Students</a>
    ...
    <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="allCourses.php">All Courses</a>
                <a class="collapse-item" href="pendingCourses.php">Pending Courses</a>
                <a class="collapse-item" href="approvedCourses.php">Approved Courses</a>
                <a class="collapse-item" href="freeBookings.php">Free Bookings</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item active">
        ...
        <div id="collapseRevenue" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Custom Utilities:</h6>
                <a class="collapse-item" href="teacherPayment.php">Teacher Payment-paid</a>
                <a class="collapse-item" href="teacherPaymentpending.php">Teacher Payment-pending</a>
                <a class="collapse-item" href="studentPayment.php">Student Payment</a>
            </div>
        </div>
    </li>
