                    ...
                    <form action="../handlers/adminAddedInstructors.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input name="phone" id="phone" type="tel" class="form-control" placeholder="Contact No"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input name="degreeP" type="text" class="form-control" id="degreeP"
                                    placeholder="Degree path" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputZip">Your Subject Stream</label>
                                <input name="streem" type="text" class="form-control" id="inputZip"
                                    placeholder="Enter your Subject or Streem" required>
                            </div>
                        </div>
