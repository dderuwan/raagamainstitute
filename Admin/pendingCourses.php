...
<head>
    ...
    <script>
        function approveCourse(id) {
            window.location.href = '../handlers/approveCourse.php?id=' + id;
        }
    </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Pending Courses</h1>
                    </div>
                            ...
                            <table class="table" style="align-items: center;">
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row" style="gap: 10px;">
                                                        <button type="button" class="btn btn-success"  style = "width: 102px;"
                                                            onclick="approveCourse(<?php echo $row['id'] ?>)">Approve</button>
                                        ...
                                        echo "<tr><td colspan='8'><b>No pending courses found.</b></td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
