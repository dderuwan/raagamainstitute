...
<head>
    ...
    <script>
        function unblockStudent(id){
            window.location.href = '../handlers/unblockStudent.php?id=' + id;
        }

        function deleteStudent(id){
            window.location.href = '../handlers/deleteStudent.php?id=' + id;
        }
    </script>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Blocked Student </h1>
                    </div>
                    ...
                    <div class="col-12 ">
                        <div class="card shadow mb-4">
                            <table class="table" style="align-items: center;">
                                ...
                                <?php
                                $sql = "SELECT * FROM student WHERE status = 'Blocked' ORDER BY `id` ASC";
                                ...
                                ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Name: <?php echo $row["firstName"] ?></br>
                                                ...
                                                <td>
                                                    <!-- <div class="dropdown">
                                                            <select name="language" id="statusSelect">
                                                    ...
                                                    <div style="display:flex; justify-content:center; align-items:center; flex-direction:column; gap:5px;">
                                                        <button type="button" class="btn btn-success" onclick="unblockStudent(<?php echo $row['id'] ?>)">Unblock</button>
                                                        <button type="button" class="btn btn-danger" onclick="deleteStudent(<?php echo $row['id'] ?>)">Delete</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
