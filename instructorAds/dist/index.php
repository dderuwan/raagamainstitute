...
<div class="containerIns">
  <aside class="carouselIns">
    <div class="carouselIns__wrapper">
  ...
  <article class="instagram">
    <header class="instagram__header">
      <figure><img src="https://assets.codepen.io/108082/jake-dog.png" alt="Jake Dog" width="42" height="42"/>
        <figcaption>
          <h4 style="color:black;">Instructor Name</h4>
        </figcaption>
      </figure>
    </header>
    ...
    <footer class="instagram__buttons">
      <div class="left">
        <svg style="stroke: red;" class="instagram__icon instagram__icon--heart" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <svg style="stroke: black;" class="instagram__icon instagram__icon--comment" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <svg style="stroke: black;" class="instagram__icon instagram__icon--message" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path d="M22 3 9.218 10.083M11.698 20.334 22 3.001H2L9.218 10.084 11.698 20.334Z"></path>
        </svg>
      </div>
      <div class="right">
        <svg style="stroke: black;" class="instagram__icon instagram__icon--saved" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
