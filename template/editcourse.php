                        ...
                        ?>
                                <div class="col-12 grid-margin stretch-card">
                                    <div class="card" style="background-color: #EEEEEE;">
                                        ...
                                        <div class="lesson" style="gap: 8px;margin: 15px; padding: 15px; display: flex; justify-content:center; align-items: center; flex-direction:row; background-color:white;">
                                            <div>
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <input type="text" value="<?php echo $row["price"] ?>" class="form-control" style="background-color: white; color:#002B45;" id="exampleFormControlInput1">
                                        </div>
