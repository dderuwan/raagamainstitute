                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="../../handlers/textlessionAdder.php" method="post" enctype="multipart/form-data">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="level" class="form-control" id="selectField" onchange="toggleFields()" style="border: 1px solid black; background-color:white;">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-4">
                                            <button type="submit" name="addlesson" class="btn btn-primary" style="margin-top: 20px;">Create text lesson</button>
                                        </div>
