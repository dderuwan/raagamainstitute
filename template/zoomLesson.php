                                ...
                                <form action="../../handlers/textlessionAdder.php" method="post" enctype="multipart/form-data">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group mt-2">
                                            <label for="exampleFormControlInput1">Zoom lesson Name</label>
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <input name="meetingPassword" type="text" class="form-control" style="background-color: white; color:black;" id="exampleFormControlInput1">
                                        </div>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <select name="level" class="form-control" style="border: 1px solid black; background-color:white;" id="exampleFormControlSelect1">
                                                ...
                                                <option value="Development"> Alfa Time Zone Military UTC +1</option>
                                                <option value="1">Australia UTC +10:30</option>
                                                <option value="12">Australia UTC +9:30</option>
                                                <option value="12">South America UTC -5</option>
                                                <option value="12">Australia UTC +9:30 / +10:30</option>
                                                <option value="12">Australia UTC +9:30 / +10:30</option>
                                            </select>
                                        </div>
