...
<head>
    ...
    <style>
        ...
        .nav-tabs .nav-link.active {
            background-color: #2DB089 !important;
                                                ...
                                                <div class="list-group border" style="background-color: #f8f9fa;">
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item p-4" style="background-color:#f8f9fa;">
                                                            <i class="fa fa-users" style="color: #2DB089" aria-hidden="true"></i>
                                                            <span class="course-detail-span">
                                                                Enrolled : <?php echo 0 ?>
                                                            </span>
                                                        </li>
                                                        <li class="list-group-item p-4" style="background-color:#f8f9fa;">
                                                            <i class="fas fa-clock" style="color: #2DB089"></i>
                                                            <span class="course-detail-span">
                                                                Duration : <?php echo 0 ?>
                                                                <span>
                                                        </li>
                                                        <li class="list-group-item p-4" style="background-color:#f8f9fa;">
                                                            <i class="fas fa-chalkboard-teacher" style="color: #2DB089"></i>
                                                            <span class="course-detail-span">
                                                                Lectures : <?php echo $RowI['FirstName']." ".$RowI['LastName'] ?>
                                                                <span>
                                                        </li>
                                                        <li class="list-group-item p-4" style="background-color:#f8f9fa;">
                                                            <i class="fas fa-video" style="color: #2DB089"></i>
                                                            <span class="course-detail-span">
                                                                Videos : <?php echo 0 ?>
                                                                <span>
                                                        </li>
                                                        <li class="list-group-item p-4" style="background-color:#f8f9fa;">
                                                            <i class="fas fa-signal" style="color: #2DB089"></i>
                                                            <span class="course-detail-span">
                            ...
                            <div class="col">
                                ...
                                <div class="row" style="background-color: #f8f9fa;margin: 50px 0px 0px;">
                                    <div class="profile-card">
                                        <div class="image">
                                            <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/331810/sq-sample17.jpg" alt="" class="profile-pic">
                                        </div>
            ...
            <div class="section-title">
                <div class="row">
                    ...
                    <div class="write-review-button">
                        <a href="#"
                        class="btn mt-1"
                        style="background-color: #007bff; color: white; text-align: center; width: 170px;" 
