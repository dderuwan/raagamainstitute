...
if (isset($_GET['id'])) {
    ...
    $sql = "UPDATE courses SET status = 'Hold' WHERE id = ?";
        ...
        if (mysqli_stmt_execute($stmt)) {
            if (mysqli_num_rows($resultemail) > 0) {
                while ($row = mysqli_fetch_array($resultemail)) {
                    ...
                    $mail->isHTML(true);
                    $mail->Subject = 'Your Course is holded';
                    $bodyContent = "
                    <html>
                        ...
                        <body>
                            ...
                            <tr>
                                    ...
                                    Your $course course is added to hold position.
                                    </td>
                                     </tr>
                
                                <tr>
                                    <td>
                                    <p>If you want to more details, please feel free to contact our support team at support@RaagamaInstitute.com or +94112345688.
                                    </p>
                                    </td>
                                </tr>
