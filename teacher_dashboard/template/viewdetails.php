                ...
                <div class="row">
                    ...
                    <div class="col-md-12 grid-margin stretch-card card">
                        <div class="row">
                            <!-- my cources -->
                            <div class="col-12">
                                <div class="card-body" style="background-color: #A8FFAD; margin: 12px; border-radius: 15px;">
                                    <div class="d-flex flex-row justify-content-between">
                                        <h4 class="card-title mb-1">Active Courses</h4>
                                    </div>
                                    <hr>
                                    <div class="col-12 mt-1 table-wrapper">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th scope="col" class="text-center">Cource Name</th>
                                                    <th scope="col" class="text-center">Individual Price</th>
                                                    <th scope="col" class="text-center">Group Price</th>
                                            ...
                                            <?php
                                                ...
                                                $sql = "
                                                    SELECT c.*,
                                                        GROUP_CONCAT(IF(co.package_type = 1, co.price, NULL)) AS individual_price,
                                                        GROUP_CONCAT(IF(co.package_type = 2, co.price, NULL)) AS group_price,
                                                        GROUP_CONCAT(IF(co.package_type = 3, co.price, NULL)) AS master_price
                                                    FROM courses c
                                                    LEFT JOIN course_options co ON c.id = co.cou_id
                                                    WHERE c.status = 'Approved' 
                                                    AND c.instructor_email = '" . $email . "' 
                                                    AND c.instructor_id = '" . $id . "'
                                                    GROUP BY c.id"; 
                                                ...
                                                ?>      
                                                        <tr>
                                                            ...
                                                            <td class="text-center">Rs <?php echo isset($row['individual_price']) ? $row['individual_price'] : 'Null'; ?> </td>
                                                            <td class="text-center">Rs <?php echo isset($row['group_price']) ? $row['group_price'] : 'Null'; ?> </td>
                                                            <td class="text-center">Rs <?php echo isset($row['master_price']) ? $row['master_price'] : 'Null'; ?></td>
                                                            <?php
                                                                $courseID = $row['id'];
                                                                $SQLSTU = "SELECT COUNT(*) AS studentNo FROM `payedstudent` WHERE instructor_ID = $InstID AND course_id = $courseID";
                                                                $RESULTSTU = mysqli_query($connection, $SQLSTU);
                                                                $ROWSTU = mysqli_fetch_array($RESULTSTU);
                                                            ?>
                                                            <td class="text-center"><?php echo $ROWSTU['studentNo'] ?></td>
                                ...
                                <div class="card-body" style="background-color: #FFF1A8; margin: 12px; border-radius: 15px;">
                                    <div class="d-flex flex-row justify-content-between">
