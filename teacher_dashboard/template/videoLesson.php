...
<head>
    ...
    <script>
        function toggleFields() {
            ...
            if (selectField.value === "youtube") {
                youtubeInput.style.display = "block";
                externalInput.style.display = "none";
                htmlInput.style.display = "none";
                htmlInput2.style.display = "none";
            } else if (selectField.value === "external") {
                youtubeInput.style.display = "none";
                externalInput.style.display = "block";
                htmlInput.style.display = "none";
                htmlInput2.style.display = "none";
            } else if (selectField.value === "html") {
                youtubeInput.style.display = "none";
                externalInput.style.display = "none";
                htmlInput.style.display = "block";
                htmlInput2.style.display = "block";
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title" style="color: black;"> Create Text Lesson </h3>
                </div>
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="../../handlers/videolessionAdder.php" method="post" enctype="multipart/form-data">
                                    ...
                                    ?>
                                        <input type="hidden" name="sectionID" id="sectionID" value="<?php echo $sId ?>">
                                        ...
                                        <div class="form-group mt-2">
                                            <label for="exampleFormControlInput1">Video lesson Name</label>
                                            <input name="lesson_name" type="text" class="form-control" style="background-color: white; color:black;" id="exampleFormControlInput1">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleFormControlSelect1">Source type</label>
                                            <select name="sourse" class="form-control" id="selectField" onchange="toggleFields()" style="border: 1px solid black; background-color:white;">
                                                <option value="">--Select course level--</option>
                                                <option value="html">Mp4</option>
                                        ...
                                        <!-- <div id="youtubeInput" class="form-group mt-2">
                                            <label for="youtubeLink">YouTube Link:</label>
                                            <input type="text" id="youtubeLink" name="youtubeLink" style="background-color: white;  color:black;" class="form-control">
                                        </div>

                                        <div id="externalInput" class="form-group mt-2">
                                            <label for="externalInput"> External Link:</label>
                                            <input type="text" id="externalLink" name="externalLink" style="background-color: white;  color:black;" class="form-control">
                                        </div>
                                        ...
                                        <div id="youtubeInput" class="form-group mt-2" style="display: none;">
                                            <label for="youtubeLink">YouTube Link:</label>
                                            <input type="text" id="youtubeLink" name="youtubeLink" style="background-color: white;  color:black;" class="form-control">
                                        </div>

                                        <div id="externalInput" class="form-group mt-2" style="display: none;">
                                            <label for="externalInput">External Link:</label>
                                            <input type="text" id="externalLink" name="externalLink" style="background-color: white;  color:black;" class="form-control">
                                        </div>

                                        <div id="htmlInput" class="form-group mt-2" style="display: none;">
                                            <label for="htmlCode">Upload your video here</label>
                                            <input type="file" id="htmlCode" name="htmlCode" class="form-control"></input>
                                        </div>

                                        <div id="htmlInput2" class="form-group mt-2" style="display: none;">
                                            <label for="htmlCode">Upload video cover</label>
                                            <input type="file" id="htmlCode" name="htmlCode" class="form-control"></input>
                                        </div>

                                        <div class="form-group mt-2">
                                            <label for="exampleFormControlInput1">Lesson duration</label>
                                            <input name="lesson_duration" type="text" class="form-control" style="background-color: white;  color:black;" id="exampleFormControlInput1">
                                        </div>

                                        <div class="form-group mt-2">
                                            <label for="exampleFormControlInput1">Lesson Start Date</label>
                                            <input name="start_date" type="date" class="form-control" style="background-color: white;  color:black;" id="exampleFormControlInput1">
                                        </div>

                                        <div class="form-group mt-2">
                                            <label for="exampleFormControlInput1">Lesson End Date</label>
                                            <input name="end_date" type="date" class="form-control" style="background-color: white;  color:black;" id="exampleFormControlInput1">
                                        </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-4">
                                            <button type="submit" name="addlesson" class="btn btn-primary" style="margin-top: 20px;">Create video lesson</button>
                                        </div>
                ...
                <!-- <select id="selectField" onchange="toggleFields()">
