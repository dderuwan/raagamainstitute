                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-12 mb-2">
                                                    <div class="row">
                                                        <div class="col-12 col-md-2" style="font-size: 15px;">Name on
                                                            card</div>
                                                ...
                                                <div class="col-12 mb-2">
                                                    <div class="row">
                                                        <div class="col-12 col-md-2" style="font-size: 15px;">Card
                                                            Number</div>
                                                        <div class="col-12 col-md-9"> <input type="text"
                                                                class="form-control"
                                                                style="color: black;background-color: white;"
                                                ...
                                                <div class="col-12 mb-2">
                                                    <div class="row">
                                                        <div class="col-12 col-md-2" style="font-size: 15px;">Expiration
                                                            Date</div>
                                                        <div class="col-12 col-md-9"> <input type="text"
                                                                class="form-control"
                                                                style="color: black;background-color: white;"
                                                ...
                                                <div class="col-12 mb-2">
                                                    <div class="row">
                                                        <div class="col-12 col-md-2" style="font-size: 15px;">CVV</div>
                                                        <div class="col-12 col-md-9"> <input type="text"
                                                                class="form-control"
                                                                style="color: black;background-color: white;"
                                                                placeholder="CVV"></div>
                                                ...
                                                <div class="col-12 mb-2">
                                                    <div class="row">
                                                        <div class="col-12 col-md-2" style="font-size: 15px;">Country
                                                        </div>
                                                        <div class="col-12 col-md-9">

                                                            <select id="country" name="country" class="form-control "
                                                                style="color: black;background-color: white;border-color: black;outline: black;">
                                                ...
                                                <div class="col-6 mt-3">
                                                    <button class="btn btn-primary p-2 w-50">Save</button>
                                                </div>
